...
var description = 'Lipsum is a program used to generate lorem ipsum text '
description += 'and to test help output for the command module.\n\n';
description += 'If the -l | --latin option is specified ';
description += 'and it looks like latin then it does nothing, other more ';
...
description += 'valid, they illustrate some of the functionality of the ';
description += 'command module.\n\n';
description += 'When invoked without the -h | --help option the program will ';
description += 'print some lorem ipsum paragraphs.';
var sections = {};
